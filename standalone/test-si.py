...
num_kpts_loc = 64
mp_grid_loc = [4, 4, 4]
real_lattice_loc = np.asarray([[-2.6988, 0.0000, -2.6988],[0.0000, 2.6988, 2.6988],[2.6988, 2.6988, 0.0000]], dtype = float) #in C order
...
atoms_frac_loc = np.asarray([[-0.25, 0.0],[0.75,0.0],[-0.25, 0.0]]) #in C order
