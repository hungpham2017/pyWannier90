...
subroutine wannier_setup(seed__name,mp_grid_loc,num_kpts_loc,&
  ...
  character(len=9), intent(in) :: seed__name
  ...
  !-----Modified to be used as library for PySCF-----
...
!  seedname="wannier"
  ...
  write(stdout,'(/a/)') ' Wannier90_setup is running in LIBRARY MODE via pyWannier90'
...
!  seedname="wannier"
  ...
  write(stdout,'(/a/)') ' Wannier90_run is running in LIBRARY MODE via pyWannier90'
